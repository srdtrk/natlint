...
mod tests {
    use super::{
        CommentTag, CommentsRef, EventDefinition, MissingParam, Rule, Violation, ViolationError,
    };
    ...
    macro_rules! test_missingparams {
        ($name:ident, $source:expr, $expected:expr) => {
            ...
            fn $name() {
                ...
                let item = child.as_event().unwrap();
    ...
    test_missingparams!(
        ...
        interface Test {
            /// @param a Some param
            /// @param b Some param
            event TestEvent(address a, address b);
        }
        ",
        |_| None
    );
    ...
    test_missingparams!(
        ...
        ",
        |item: &EventDefinition| Some(Violation::new(
            MissingParam::NAME,
